...
declare global {
  ...
  const JSONStream: typeof import('../src/utils/JSONStream.js')['JSONStream']
  ...
  const formatDate: typeof import('../src/utils/rewrite')['formatDate']
  const formatUserMessage: typeof import('../src/utils/rewrite')['formatUserMessage']
  ...
  const getStatusType: typeof import('../src/utils/rewrite')['getStatusType']
  const h: typeof import('vue')['h']
  const hasKnowledgeBeenShownFirstTime: typeof import('../src/utils/tour.js')['hasKnowledgeBeenShownFirstTime']
  const hasWebsiteBeenShownFirstTime: typeof import('../src/utils/tour.js')['hasWebsiteBeenShownFirstTime']
  ...
  const jSONStream: typeof import('../src/utils/JSONStream.js')['default']
  ...
  const setKnowledgeFirstShowStatus: typeof import('../src/utils/tour.js')['setKnowledgeFirstShowStatus']
  const setWebsiteFirstShowStatus: typeof import('../src/utils/tour.js')['setWebsiteFirstShowStatus']
  ...
  const t: typeof import('../src/hooks/use-i18n')['t']
  ...
  const useI18n: typeof import('../src/hooks/use-i18n')['useI18n']
  ...
  const userTemplate: typeof import('../src/utils/rewrite')['userTemplate']
