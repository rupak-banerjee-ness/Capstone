...
class LLMModelService:
    ...
    def create_model(data: Dict[str, Any]) -> LLMModel:
        ...
        # Provider-prefixed models (e.g. "bedrock/...") authenticate via
        # provider-specific env vars instead of an explicit api_base.
        if deployment_type == "cloud" and '/' not in data.get('name', '') and not data.get('api_base'):
        ...
        return {
            ...
            'aws_region_name': model.aws_region_name,
